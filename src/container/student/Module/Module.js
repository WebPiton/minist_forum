                        ...
                        <div className="moduleBlock">
                            <div className="module">
                                <div className="moduleInfo">
                                    {this.state.nesting === 0 ? <p>Предмет: {this.props.location.state.parentName}</p> : <p>Модуль: {this.state.module.name}</p>}
                                    ...
                                    return (
                                        <React.Fragment>
                                            {item.childIds.length > 0 && item.access ?
                                                ...
                                                </div> : item.childIds.length === 0 && item.access ?
                                                <Link
                                                    to={{
                                                        pathname: "/test/",
